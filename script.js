...
if (!animationCanvas || !chartCanvas) return;
...
if (legend) {
    legend.innerHTML = `
        <span style="color:${COLORS.S}">🧍 Susceptible</span>
        <span style="color:${COLORS.I}">🦠 Infected</span>
        <span style="color:${COLORS.R}">🛡️ Recovered</span>
    `;
}
